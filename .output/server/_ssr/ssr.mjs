...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CeCTQUi3.mjs");
...
var manifest = { "b269b7b1feff1aa2f8e13ef84501dc64cb2e2b1ffc655ecff782e63e3085735e": {
	functionName: "saveLead_createServerFn_handler",
	importer: () => import("./actions-CDRMRX-i.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D_WkdUd5.mjs").then((n) => n.t),
