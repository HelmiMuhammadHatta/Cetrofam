...
import { l as require_react_dom, v as require_with_selector, z as require_react } from "./@tanstack/react-router+[...].mjs";
...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$22({}, svgPropertiesAndEvents(others), {
...
var getCartesianPosition = (options) => {
	...
	if (position === "insideLeft") return _objectSpread$34({
		x: middleX + horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$34({
		x: middleX + midHeightWidth - horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$34({
		x: upperX + upperWidth / 2,
		y: y + verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$34({
		x: lowerX + lowerWidth / 2,
		y: y + height - verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$34({
		x: upperX + horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$34({
		x: upperX + upperWidth - horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$34({
		x: lowerX + horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$34({
		x: lowerX + lowerWidth - horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$34({
		x: x + getPercentValue(position.x, midHeightWidth),
		y: y + getPercentValue(position.y, height),
		horizontalAnchor: "end",
		verticalAnchor: "end"
	}, sizeAttrs);
	return _objectSpread$34({
		x: centerX,
		y: y + height / 2,
		horizontalAnchor: "middle",
		verticalAnchor: "middle"
	...
	if (legendSettings && legendSize) {
		...
		if (position != null) {
			if (isOutsidePosition(position)) {
				if (position === "top" && isNumber(offset.top)) return _objectSpread$32(_objectSpread$32({}, offset), {}, { top: offset.top + (boxHeight || 0) + legendOffset });
				if (position === "bottom" && isNumber(offset.bottom)) return _objectSpread$32(_objectSpread$32({}, offset), {}, { bottom: offset.bottom + (boxHeight || 0) + legendOffset });
				if (position === "left" && isNumber(offset.left)) return _objectSpread$32(_objectSpread$32({}, offset), {}, { left: offset.left + (boxWidth || 0) + legendOffset });
				if (position === "right" && isNumber(offset.right)) return _objectSpread$32(_objectSpread$32({}, offset), {}, { right: offset.right + (boxWidth || 0) + legendOffset });
			}
			return offset;
		}
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement(SizeDetectorContainer, _extends$20({}, props, {
		width,
		height,
		ref
	}));
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				if (finalFormatter) {
					...
					if (Array.isArray(formatted)) {
						var _formatted = _slicedToArray$17(formatted, 2);
...
function TooltipBoundingBoxImpl(props) {
	...
	var _React$useState2 = _slicedToArray$15(import_react.useState(() => ({
		dismissed: false,
...
var Cross = (_ref) => {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$15(_ref, _excluded$15);
...
var RechartsAnimation = class {
	...
	*/
	...
	constructor(param) {
		...
		_defineProperty$28(this, "state", INIT);
...
function JavascriptAnimate(outsideProps) {
	...
	var _useState2 = _slicedToArray$14((0, import_react.useState)(isActive ? from : to), 2), style = _useState2[0], setStyle = _useState2[1];
	(0, import_react.useEffect)(() => {
...
var Rectangle = (rectangleProps) => {
	...
	var _useState2 = _slicedToArray$13((0, import_react.useState)(-1), 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
	(0, import_react.useEffect)(() => {
	...
	if (!isUpdateAnimationActive) {
		...
		var otherPathProps = _objectWithoutProperties$14(_svgPropertiesAndEven, _excluded$14);
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var otherPathProps = _objectWithoutProperties$14(_svgPropertiesAndEven2, _excluded2$9);
		return /*#__PURE__*/ import_react.createElement("path", _extends$16({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
			d: getRectanglePath(currX, currY, currWidth, currHeight, radius),
			ref: pathRef,
			style: _objectSpread$25(_objectSpread$25({}, animationStyle), props.style)
		}));
	});
};
//#endregion
...
var inRangeOfSector = (_ref5, viewBox) => {
	...
	if (inRange) return _objectSpread$24(_objectSpread$24({}, viewBox), {}, {
		radius,
...
function isWellFormedNumberDomain(v) {
	if (Array.isArray(v) && v.length === 2) {
		var _v = _slicedToArray$12(v, 2), min = _v[0], max = _v[1];
...
function numericalDomainSpecifiedWithoutRequiringData(userDomain, allowDataOverflow) {
	...
	if (Array.isArray(userDomain) && userDomain.length === 2) {
		var _userDomain = _slicedToArray$12(userDomain, 2), providedMin = _userDomain[0], providedMax = _userDomain[1];
...
function parseNumericalUserDomain(userDomain, dataDomain, allowDataOverflow) {
	...
	if (Array.isArray(userDomain) && userDomain.length === 2) {
		var _userDomain2 = _slicedToArray$12(userDomain, 2), providedMin = _userDomain2[0], providedMax = _userDomain2[1];
		var finalMin, finalMax;
		if (providedMin === "auto") {
...
var getValidInterval = (_ref) => {
	var _ref2 = _slicedToArray$11(_ref, 2), min = _ref2[0], max = _ref2[1];
...
var getNiceTickValues = function getNiceTickValues(_ref3) {
	var _ref4 = _slicedToArray$11(_ref3, 2), min = _ref4[0], max = _ref4[1];
	var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
	var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
	var niceTicksMode = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "auto";
	var count = Math.max(tickCount, 2);
	var _getValidInterval2 = _slicedToArray$11(getValidInterval([min, max]), 2), cormin = _getValidInterval2[0], cormax = _getValidInterval2[1];
...
var getTickValuesFixedDomain = function getTickValuesFixedDomain(_ref5, tickCount) {
	var _ref6 = _slicedToArray$11(_ref5, 2), min = _ref6[0], max = _ref6[1];
	var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
	var niceTicksMode = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "auto";
	var _getValidInterval4 = _slicedToArray$11(getValidInterval([min, max]), 2), cormin = _getValidInterval4[0], cormax = _getValidInterval4[1];
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
	...
	return _objectSpread$23(_objectSpread$23({}, implicitAngleAxis), {}, { type: evaluatedType });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
	...
	return _objectSpread$23(_objectSpread$23({}, implicitRadiusAxis), {}, { type: evaluatedType });
});
...
function getErrorDomainByDataKey(entry, appliedValue, relevantErrorBars) {
	...
	return onlyAllowNumbers(relevantErrorBars.flatMap((eb) => {
		...
		if (Array.isArray(errorValue)) {
			var _errorValue = _slicedToArray$10(errorValue, 2);
...
var combineStackGroups = (displayedData, items, stackOffsetType, reverseStackOrder) => {
	...
	return Object.fromEntries(Object.entries(itemsGroup).map((_ref3) => {
		var _ref4 = _slicedToArray$10(_ref3, 2), stackId = _ref4[0], graphicalItems = _ref4[1];
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
	if (axis == null || scale == null) return;
	return _objectSpread$22(_objectSpread$22({}, axis), {}, { scale });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
	...
	if (hasBeenActivePreviously(appropriateMouseInteraction)) {
		if (activeFromProps) return _objectSpread$21(_objectSpread$21({}, appropriateMouseInteraction), {}, { active: true });
	...
	return _objectSpread$21(_objectSpread$21({}, noInteraction), {}, { coordinate: appropriateMouseInteraction.coordinate });
};
//#endregion
...
var combineTooltipPayload = (tooltipPayloadConfigurations, activeIndex, chartDataState, tooltipAxisDataKey, activeLabel, tooltipPayloadSearcher, tooltipEventType) => {
	...
	return tooltipPayloadConfigurations.reduce((agg, _ref) => {
		...
		if (Array.isArray(tooltipPayload)) tooltipPayload.forEach((item) => {
			...
			var newSettings = _objectSpread$20(_objectSpread$20({}, settings), {}, {
				name: itemName,
...
var useTooltipAxisBandSize = () => {
	...
	return getBandSizeOfAxis(_objectSpread$19(_objectSpread$19({}, tooltipAxis), {}, { scale: tooltipAxisScale }), tooltipTicks);
};
//#endregion
...
var getActivePolarCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
	...
	if (entry) {
		if (layout === "centric") {
			...
			return _objectSpread$18(_objectSpread$18(_objectSpread$18({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
				angle: _angle,
				radius: _radius
			});
		}
		...
		return _objectSpread$18(_objectSpread$18(_objectSpread$18({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
			angle,
			radius
		});
	}
...
var initialState$4 = { zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current) => _objectSpread$17(_objectSpread$17({}, acc), {}, { [current]: {
	element: void 0,
...
function CursorInternal(props) {
	...
	var cursorProps = _objectSpread$16(_objectSpread$16(_objectSpread$16(_objectSpread$16({
		stroke: "#ccc",
		pointerEvents: "none"
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, _x = _action$payload$coord.x, _y = _action$payload$coord.y, otherCoordinateProps = _objectWithoutProperties$13(_action$payload$coord, _excluded$13);
					...
					var scaledCoordinate = _objectSpread$15(_objectSpread$15({}, otherCoordinateProps), {}, {
						x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
						y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
					});
					dispatch(_objectSpread$15(_objectSpread$15({}, action), {}, { payload: _objectSpread$15(_objectSpread$15({}, action.payload), {}, { coordinate: scaledCoordinate }) }));
...
function Tooltip(outsideProps) {
	...
	var _useElementOffset2 = _slicedToArray$9(useElementOffset([payload, finalIsActive]), 2), lastBoundingBox = _useElementOffset2[0], updateBoundingBox = _useElementOffset2[1];
	...
	var tooltipContentProps = _objectSpread$14(_objectSpread$14({}, props), {}, {
...
var LRUCache = class {
	constructor(maxSize) {
		_defineProperty$15(this, "cache", /* @__PURE__ */ new Map());
...
var currentConfig = _objectSpread$13({}, {
	cacheSize: 2e3,
	enableCache: true
});
...
_defineProperty$13(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
function calculateParentheses(expr) {
	...
	while ((match = PARENTHESES_REGEX.exec(newExpr)) != null) {
		var parentheticalExpression = _slicedToArray$8(match, 2)[1];
...
var calculateWordsByLines = (_ref3, initialWordsWithComputedWith, spaceWidth, lineWidth, scaleToFit) => {
	...
	while (start <= end && iterations <= text.length - 1) {
		...
		var _checkOverflow2 = _slicedToArray$7(checkOverflow(text, middle - 1, breakAll, style, maxLines, lineWidth, spaceWidth, scaleToFit), 2), doesPrevOverflow = _checkOverflow2[0], result = _checkOverflow2[1];
		var doesMiddleOverflow = _slicedToArray$7(checkOverflow(text, middle, breakAll, style, maxLines, lineWidth, spaceWidth, scaleToFit), 1)[0];
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	...
	var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$12(props, _excluded2$8);
...
function LabelList(_ref) {
	var _ref$valueAccessor = _ref.valueAccessor, valueAccessor = _ref$valueAccessor === void 0 ? defaultAccessor : _ref$valueAccessor, restProps = _objectWithoutProperties$10(_ref, _excluded$10), dataKey = restProps.dataKey;
	restProps.clockWise;
	var id = restProps.id, textBreakAll = restProps.textBreakAll, zIndex = restProps.zIndex, others = _objectWithoutProperties$10(restProps, _excluded2$6);
...
var Dot = (props) => {
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(r)) return /*#__PURE__*/ import_react.createElement("circle", _extends$10({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
function mergeShapeProps(option, props) {
	return _objectSpread$11(_objectSpread$11({}, props), option);
}
...
*/
var useIdFallback = () => {
	return _slicedToArray$4(import_react.useState(() => uniqueId("uid-")), 1)[0];
};
...
function DotItem(_ref) {
	...
	_ref2.points;
	var props = _objectWithoutProperties$9(_ref2, _excluded$9);
	return /*#__PURE__*/ import_react.createElement(Dot, _extends$9({}, props, { className: finalClassName }));
}
...
function Dots(_ref3) {
	...
	var dots = points.map((entry, i) => {
		...
		var dotProps = _objectSpread$10(_objectSpread$10(_objectSpread$10({ r: 3 }, baseProps), customDotProps), {}, {
			index: i,
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex }, /*#__PURE__*/ import_react.createElement(Layer, _extends$9({ className }, layerProps), dots));
}
//#endregion
	...
	reducers: {
		...
		updateXAxisHeight(state, action) {
			...
			if (axis) {
				...
				state.xAxis[id] = _objectSpread$9(_objectSpread$9({}, axis), {}, {
					height,
...
var ClipPathProvider = (_ref) => {
	...
	var clipPathId = _slicedToArray$3((0, import_react.useState)("".concat(uniqueId("recharts"), "-clip")), 1)[0];
...
function AxisLine(axisLineProps) {
	...
	return /*#__PURE__*/ import_react.createElement("line", _extends$8({}, props, { className: clsx("recharts-cartesian-axis-line", get(axisLine, "className")) }));
}
/**
...
function TickItem(props) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) tickItem = /*#__PURE__*/ import_react.cloneElement(option, _objectSpread$6(_objectSpread$6({}, tickProps), {}, { className: combinedClassName }));
		...
		tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$8({}, tickProps, { className }), value);
	}
	return tickItem;
}
...
var Ticks = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	var tickLines = tickLineCoords.map((_ref2) => {
		...
		}, tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$8({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", get(tickLine, "className")) })));
	});
...
var CartesianAxisComponent = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var axisLine = props.axisLine, width = props.width, height = props.height, className = props.className, hide = props.hide, ticks = props.ticks, axisType = props.axisType, axisId = props.axisId, rest = _objectWithoutProperties$8(props, _excluded$8);
	var _useState2 = _slicedToArray$2((0, import_react.useState)(""), 2), fontSize = _useState2[0], setFontSize = _useState2[1];
	var _useState4 = _slicedToArray$2((0, import_react.useState)(""), 2), letterSpacing = _useState4[0], setLetterSpacing = _useState4[1];
...
var CartesianAxis = /*#__PURE__*/ import_react.forwardRef((outsideProps, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement(CartesianAxisComponent, _extends$8({}, props, { ref }));
});
...
var _excluded3$2 = ["xAxisId", "yAxisId"];
var _excluded4 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) lineItem = /*#__PURE__*/ import_react.cloneElement(option, lineItemProps);
		...
		var x1 = lineItemProps.x1, y1 = lineItemProps.y1, x2 = lineItemProps.x2, y2 = lineItemProps.y2, key = lineItemProps.key, _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(_objectWithoutProperties$7(lineItemProps, _excluded$7))) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {};
		_ref2.offset;
		var restOfFilteredProps = _objectWithoutProperties$7(_ref2, _excluded2$5);
...
function HorizontalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$7(props, _excluded3$2);
...
function VerticalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$7(props, _excluded4);
...
function CartesianGrid(props) {
	...
	}), /*#__PURE__*/ import_react.createElement(HorizontalStripes, _extends$7({}, propsIncludingDefaults, { horizontalPoints })), /*#__PURE__*/ import_react.createElement(VerticalStripes, _extends$7({}, propsIncludingDefaults, { verticalPoints })), /*#__PURE__*/ import_react.createElement(HorizontalGridLines, _extends$7({}, propsIncludingDefaults, themeProps, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(VerticalGridLines, _extends$7({}, propsIncludingDefaults, themeProps, {
		offset,
		verticalPoints,
		xAxis,
		yAxis
...
var selectStackDataKeys = createSelector([selectSynchronisedAreaSettings, selectNumericalAxisStackGroups], (areaSettings, stackGroups) => {
	if (areaSettings == null || areaSettings.stackId == null || stackGroups == null) return;
...
function AreaRevealShape(props) {
	...
	var strokeSvgProps = svgPropertiesNoEvents(_objectWithoutProperties$6(restProps, _excluded2$4));
	var fillCurve = /*#__PURE__*/ import_react.createElement(Curve, _extends$6({}, restProps, {
		id,
		baseLine,
	...
	var strokeCurve = stroke !== "none" && /*#__PURE__*/ import_react.createElement(Curve, _extends$6({}, strokeSvgProps, {
	...
	var baselineCurve = stroke !== "none" && isRange && Array.isArray(baseLine) && /*#__PURE__*/ import_react.createElement(Curve, _extends$6({}, strokeSvgProps, {
		className: "recharts-area-curve",
		layout,
		type: restProps.type,
		connectNulls: finalConnectNulls,
...
function StaticArea(_ref4) {
	...
	var curveProps = _objectSpread$4(_objectSpread$4({}, svgPropertiesAndEvents(propsWithoutId)), {}, {
		id,
		points,
		connectNulls,
		type,
...
function computeArea(_ref8) {
	...
	var points = displayedData.map((entry, index) => {
		...
		if (hasStack) valueAsArray = stackedData[dataStartIndex + index];
			...
			if (!Array.isArray(_rawValue)) valueAsArray = [baseValue, _rawValue];
			else {
